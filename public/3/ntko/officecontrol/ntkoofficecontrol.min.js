...
//32位控件包的路径
var codebase = '/3/ntko/officecontrol/OfficeControl.cab#version=6,0,1,0'
//64位控件包的路径
var codebase64 = '/3/ntko/officecontrol/OfficeControlx64.cab#version=6,0,1,0'
//设置高度
var height = '99%'
//设置宽度
var width = '100%'
//买断授权密钥如果不是买断可以不用写
var MakerCaption = '广州市翼迅信息科技有限公司'
//买断授权密钥如果不是买断可以不用写
var MakerKey = '0227F2FBA947ADF126806076A4038CCA0D957300'
//密钥
var ProductCaption = '广东省环境监测中心'
//密钥
var ProductKey = 'C18A173040D0B4C3F5444F47F0FDAE61625B1F03'
...
if (browser == 'IE') {
  if (window.navigator.platform == 'Win32') {
    ...
    document.write('<param name="Caption" value="查看正文">   ')
    document.write('<param name="WebFileName" value="' + file_name_str + '">   ')
    document.write('<SPAN STYLE="color:red">不能装载文档控件。请在检查浏览器的选项中检查浏览器的安全设置。</SPAN>&nbsp;<a href="/3/ntko/officecontrol/ntkosetup.exe" style="color:blue;">点击下载安装</a>   ')
