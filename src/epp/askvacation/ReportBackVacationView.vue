<template>
    <page-view title="销假信息">
        ...
        <a-button type="primary" @click="onView">编辑</a-button>
        </template>
        <a-card>
                ...
                <a-tab-pane tab="请休假申请信息" key="1">
                    <table class="fx-form-view">
                        ...
                        <tr>
                            ...
                            <th>销假日期</th>
                            <td>
                                <div>{{report.returndate}}</div>
                            </td>
                        </tr>
                        <tr>
                            <th>销假说明</th>
                            <td colspan="3">
                                <div>{{report.turnmemo}}</div>
                            </td>
                        </tr>
                        <tr>
                            <th>附件</th>
...
export default {
  ...
  methods: {
    ...
    onView () {
      this.$router.push({ path: '/askvacation/reportback?id=' + this.report.id })
    }
  }
}
</script>
