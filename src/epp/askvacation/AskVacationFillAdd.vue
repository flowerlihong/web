            ...
            <a-form :form="form1">
                <table class="fx-form" v-for="item in addresses" :key="item.id">
                    ...
                    <tr>
                        ...
                        <td>
                            <a-form-item>
                                <a-select style="width: 170px" v-model="item.configid" @change="value => onEdit(value, item.id, 'configid')">
                    ...
                    <tr>
                        ...
                        <td>
                            <a-form-item>
                                <a-input  style="margin: -5px 0;width: 50%" disabled=disabled  :value="item.vacationConfigOne.days === null? '无限制':item.vacationConfigOne.days"/>
                            </a-form-item>
                        </td>
                        <th class="not-null">请假天数</th>
                        <td>
                            <a-form-item>
                                <a-input-number :min="0" key="intentDays" style="margin: -5px 0;width: 60%"
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <a-form-item>
                                <a-textarea :value="item.vacationConfigOne.meno" disabled=disabled></a-textarea>
                            </a-form-item>
                        </td>
                    </tr>
                    <tr>
