  ...
  methods: {
    ...
    uploadImgRemote () {
      ...
      that.$refs.cropper.getCropData(data => {
        that.$http.post('/api/1/staff/certificate_avatar_base64.json?', qs.stringify({ avatar: data, staffCertificate: that.staffCertificate })).then(function (resp) {
