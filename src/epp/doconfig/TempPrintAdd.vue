        ...
        <a-form :form="form">
                <table style="width:100%" class="fx-form">
                            <tr>
                                ...
                                <td>
                                   <a-form-item>
                                    ...
                                    'printDoctype',{rules: [{ required: true, message: '请填写打印模板类型' }]}
                                  ]" />
                                  </a-form-item>
                                </td>
                            </tr>
                            <tr>
                               ...
                               <td>
                                  <a-form-item>
                                      <a-input v-decorator="['templateName',{rules: [{ required: true, message: '请填写打印模板名称' }]}]"></a-input>
                                  </a-form-item>
                               </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                               ...
                               <td>
                                  <a-form-item>
                                    <a-input v-decorator="['storagePath',{rules: [{ required: true, message: '请填写打印模板的存放位置' }]}]"></a-input>
                                  </a-form-item>
                               </td>
                            </tr>
                  </table>
...
export default {
  ...
  methods: {
    ...
    onCate () {
      this.$http.get('/api/1/dmservices/get_print_doctype_select.json').then(
        (resp) => {
    ...
    onSubmit () {
      this.form.validateFields((err, values) => {
        ...
        this.$http.post('/api/1/dmservices/add_print_template.json', qs.stringify(data)).then(
          (resp) => {
            if (resp.code === 200) {
              this.modalLoading = false
              this.$message.success('添加打印模板成功')
              this.$emit('success')
