...
//     	   }
//
      ntkoWinOpen = window.open(strURL, '', 'height=' + ntkowidth + ', width=' + ntkowidth + ',top=0,left=0, titlebar=no,toolbar =no, menubar=no, scrollbars=no, resizable=yes, location=no, status=no')
